        ...
        <Box sx={{ flexGrow: 1, bgcolor: 'background.paper', display: 'flex' }}>
            ...
            <ul>
              ...
              <li>
                <Typography variant="body2">
                  ...
                  migration, I'm tasked with optimizing GA data collection into Big Query by auditing data as it comes
                  in during intraday/daily. This optimization will effectively clean up our GA data in our data
                  warehouse which is used by our product/sales teams. This is an ongoing project that will effectively
                  migrate all telecommunication partners from GA3 to GA4.
                </Typography>
              </li>
            </ul>
          </TabPanel>
            ...
            <ul>
              ...
              <li>
                <Typography variant="body2">
                  ...
                  Perform ad hoc advertising reporting queries as needed. Support the Market Development Manager, Online
                  Advertising with forecasting and enhanced ad server reporting as needed.
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
                  Test and validate web analytics and reports with each new deployment, product release and/or
                  enhancement in each of the reporting systems, including Literatum, Web Analytics, Google Analytics and
                  Dart for Publishers (DFP).
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
                  Develop new standard monthly internal reports as necessary, based on feedback from stakeholders within
          ...
          <TabPanel value={value} index={3}>
            <Typography variant="h3">
              ...
              <a href="https://www.senseient.com/" target={'_blank'}>
                Sensei Enterprises
              </a>
            </Typography>
            <Typography variant="subtitle1">
            ...
            <ul>
              ...
              <li>
                <Typography variant="body2">
                  Implemented social media communications into Sensei’s marketing plan and managed social media
                  properties, including daily monitoring, posting, and content development.
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
